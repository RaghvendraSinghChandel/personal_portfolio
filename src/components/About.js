  ...
  return (
    <div className="about">
      ...
      <div className="about-section">
        <p>
          I am a dedicated <strong>QA Software Engineer</strong> with over <strong>2+ years of professional experience</strong> working in 
          multiple domains, including <strong>healthcare</strong>, <strong>finance</strong>, <strong>e-commerce</strong>, and <strong>social media applications</strong>. 
          My passion for quality and precision drives me to create comprehensive <strong>test plans</strong>, design detailed <strong>test cases</strong>, 
          execute tests meticulously, and compile insightful <strong>summary reports</strong> that ensure product excellence.
        </p>
      </div>
      <div className="about-section">
        <p>
          ...
          ensuring that applications function seamlessly across various devices. My expertise also extends to performance testing, where I have used <strong>Locust</strong> to
          simulate and analyze load, ensuring that applications can scale effectively.
        </p>
      </div>
      <div className="about-section">
        <p>
